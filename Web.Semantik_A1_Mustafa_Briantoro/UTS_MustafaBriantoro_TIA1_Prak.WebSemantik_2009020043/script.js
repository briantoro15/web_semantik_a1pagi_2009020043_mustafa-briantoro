...
$('#clear').click(function() {
  ...
  if (nama_produk != "" && harga_produk != "" && qty_produk != "" && jumlah_bayar != "") {
    ...
    if (jumlah_bayar < total_bayar) {
      ...
      $("#alert_berhasil").empty(); // Menghapus pesan berhasil jika ada
      $(".hasil-pembelian").hide(); // Sembunyikan bagian hasil pembelian
    } else {
      ...
      $(".hasil-pembelian").show(); // Tampilkan bagian hasil pembelian
    }
  }
});
